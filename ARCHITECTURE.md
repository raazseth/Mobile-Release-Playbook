...
These principles follow the project's security baseline: secure boundaries, least privilege, secret protection, validation of external input, and explicit controls for AI actions.
...
This follows the broader engineering rule of making small, reversible changes and validating what the repository actually supports.
